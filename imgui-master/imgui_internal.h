...
namespace ImGui
{
    ...
    IMGUI_API bool          TabEx(const char* label, const char* icon, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          SubTabEx(const char* label, const char* icon, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
